...
(function($) {
    ...
    $('form#cf button#submit').on('click', function() {
        ...
        if (name != '' && email != '' && message != '') {
            var values = "name=" + name + "&email=" + email + "&phone=" + phone + "&message=" + message;
            $.ajax({
                type: "POST",
                url: "contact.php",
                data: values,
                success: function() {
                    ...
                    $('.cf-msg').fadeIn().css('background-color', 'rgba(98, 181, 87, 0.7)').html('<p>Email envoyé !</p>');
                    setTimeout(function() {
                        $('.cf-msg').fadeOut('slow');
                    }, 2000);
            ...
            $('.cf-msg').fadeIn().css('background-color', 'rgba(181,62,75,0.7)').html('<p>Merci de remplir les champs obligatoire.</p>')
        }
